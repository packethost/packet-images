...
cf_time='Sat Jan 25 17:54:54 UTC 2020'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg6='-Dccflags=-DDEBIAN -Wdate-time -D_FORTIFY_SOURCE=2 -g -O2 -fdebug-prefix-map=/build/perl-mBlkB0/perl-5.24.1=. -fstack-protector-strong -Wformat -Werror=format-security'
