...
cf_time='Wed Sep 11 07:02:52 UTC 2019'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg6='-Dccflags=-DDEBIAN -Wdate-time -D_FORTIFY_SOURCE=2 -g -O2 -fdebug-prefix-map=/build/perl-1_qjrE/perl-5.28.1=. -fstack-protector-strong -Wformat -Werror=format-security'
